...
const PRODUCT_SECTIONS = [
    { key: "featured", label: "Featured Supplements", icon: Star, color: "bg-yellow-500" },
    { key: "bestseller", label: "Best Sellers", icon: TrendingUp, color: "bg-green-500" },
    { key: "trending", label: "Trending in Fitness", icon: Flame, color: "bg-orange-600" },
    { key: "new", label: "New Supplement Arrivals", icon: Clock, color: "bg-blue-500" },

    // Gym / Sports Nutrition Sections
    { key: "protein", label: "Top Protein Powders", icon: Dumbbell, color: "bg-red-600" },
    { key: "gainers", label: "Mass Gainers & Weight Gain", icon: Package, color: "bg-amber-600" },
    { key: "preworkout", label: "Pre-Workout Boosters", icon: Zap, color: "bg-purple-600" },
    { key: "postworkout", label: "Post-Workout Recovery", icon: HeartPulse, color: "bg-indigo-600" },
    { key: "aminos", label: "BCAA & Amino Acids", icon: Activity, color: "bg-pink-600" },
    { key: "creatine", label: "Creatine Best Sellers", icon: Sparkles, color: "bg-teal-600" },

    // Health & Wellness
    { key: "vitamins", label: "Vitamins & Multivitamins", icon: Apple, color: "bg-orange-500" },
    { key: "immunity", label: "Immunity Boosters", icon: Shield, color: "bg-green-700" },
    { key: "fatburner", label: "Fat Burners & Shredding", icon: FireExtinguisher, color: "bg-red-700" },

    // Snacks / Drinks / Daily Nutrition
    { key: "snacks", label: "Healthy Snacks & Bars", icon: Coffee, color: "bg-amber-500" },
    { key: "drinks", label: "Energy Drinks & Hydration", icon: Droplet, color: "bg-cyan-600" },

    // Special Collections
    { key: "combo", label: "Combo Packs & Stacks", icon: Layers, color: "bg-violet-600" },
    { key: "elite", label: "Elite Athlete Collection", icon: Crown, color: "bg-rose-600" },

    // Explore
    { key: "explore", label: "Explore New Products", icon: Compass, color: "bg-sky-500" },
];
