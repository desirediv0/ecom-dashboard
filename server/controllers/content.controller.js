  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | EcomSupplements",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/ecomsupplements",
          instagram: "https://instagram.com/ecomsupplements",
          twitter: "https://twitter.com/ecomsupplements",
        },
      };
    ...
    const contactInfo = {
      ...
      email: "support@ecomsupplements.com",
      ...
      metaTitle: "Contact Us | EcomSupplements",
      metaDescription:
